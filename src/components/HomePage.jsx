    ...
    <>
      ...
      <ul className="band-description">
        ...
        <li className="band2">
          ...
          songwriting), Berry Oakley (bass guitar), Butch Trucks (drums), and
          Jai Johanny "Jaimoe" Johanson (drums). The band incorporated elements
          of blues, jazz, and country music, and their live shows featured jam
          band-style improvisation and instrumentals. The group's first two
          studio releases, The Allman Brothers Band (1969) and Idlewild South
          (1970) (both released by Capricorn Records), stalled commercially, but
          their 1971 live release, At Fillmore East, represented an artistic and
          commercial breakthrough. The album features extended renderings of
          their songs "In Memory of Elizabeth Reed" and "Whipping Post", and is
          considered among the best live albums ever made. - Source Wikipedia
        </li>
        <br></br>
        <li className="band3">
          ...
          is regarded as one of the greatest musicians of all time. His
          innovative music integrated a wide variety of styles, including funk,
          rock, R&B, new wave, soul, psychedelia, and pop. Prince pioneered the
          late 1970s Minneapolis sound, a funk rock subgenre drawing from
          synth-pop and new wave. - Source Wikipedia
        </li>
      </ul>
    </>
  )
